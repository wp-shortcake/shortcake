define( ['shortcodes/attribute.collection'], function ( AttributeCollection ) {
	'use strict';
	...
	var Shortcode = Backbone.Model.extend({
		...
		set: function( attributes, options ) {
			...
			if ( attributes.attrs !== undefined && ! ( attributes.attrs instanceof AttributeCollection ) ) {
				attributes.attrs = new AttributeCollection( attributes.attrs );
			}
		...
		toJSON: function( options ) {
			...
			if ( options.attrs !== undefined && ( options.attrs instanceof AttributeCollection ) ) {
